    ...
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      <div class="flex lg:flex-1">
        <a href="#" class="-m-1.5 p-1.5">
          <span class="sr-only">Megcom Dynamic Solution Sdn Bhd</span>
            ...
            <Popover class="relative">
              ...
              <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0 translate-y-1"
                ...
                <PopoverPanel
                  ...
                  <div class="p-4">
                    <div v-for="dropdown in item.menu" :key="dropdown.name"
                      ...
                      <div class="flex-auto">
                        <a :href="dropdown.href" class="block font-semibold text-gray-900">
                          ...
                          <template v-if="dropdown.name !== 'Other Brands'">
                            <span :style="{ backgroundImage: `url('${dropdown.bg}')` }" :class="{
